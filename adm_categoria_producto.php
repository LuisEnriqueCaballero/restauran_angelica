...
$title_pagina = 'lista de categoria producto';
?>
    ...
    <div class="adm_contenido mt-3 pt-3">
        <div class="row w-ful">
            ...
            <div class="busqueda col-sm-2 mt-3">
                <button class="btn btn-default" id="consultar" onclick="lista_categoriaproducto()"><i class="fa fa-search" aria-hidden="true"></i>
                    consultar</button>
            </div> -->
            <div class="table col-sm-12">
                <table class="table table-bordered" id="datable">
                    ...
                    <tbody id="lista_categoriaproducto">
    ...
    function lista_categoriaproducto() {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('#lista_categoriaproducto').html('<td colspan="3" align="center"></i> Cargando Entidades ... </td>');
            },
            success: function(result) {
                $("#consultar").attr("disabled", false);
                $("#consultar").html('<i class="fa fa-search" aria-hidden="true"></i> Consultar');
                $('#lista_categoriaproducto').html(result.html);
            }
        })
    }
